...
public class JwtService {
    ...
    public JwtService(ResourceLoader resourceLoader) {
        ...
        try {
            System.out.println("=== DEBUG JWT Service ===");
            System.out.println("Loading private key from: classpath:private.pem");
            ...
            System.err.println("=== JWT Service FAILED ===");
            e.printStackTrace();
    ...
    private PrivateKey loadPrivateKey() throws Exception {
        ...
        Resource resource = resourceLoader.getResource("classpath:private.pem");
